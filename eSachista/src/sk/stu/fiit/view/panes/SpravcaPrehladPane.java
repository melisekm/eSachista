...
public class SpravcaPrehladPane extends javax.swing.JPanel implements IViewRefresh {
    ...
    private void vyplnBarChart() {
        ...
        SpravcaPanel = factory.createChart("BAR", "PoËet hr·Ëov v jednotliv˝ch turnajoch", hraciTurnajeDataset);
    ...
    private void vyplnBarChartDatumy() {
        ...
        BarPieChartFactory factory = new BarPieChartFactory();
        SpravcaDatumyPanel = factory.createChart("BAR", "PoËet hr·Ëov podæa dnÌ konania turnajov", hraciTurnajeDataset);
